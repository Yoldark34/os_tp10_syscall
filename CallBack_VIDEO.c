...
T_DESCRIPTEUR_SEGMENT* L_Descripteur_Data;
   ...
   asm (".att_syntax noprefix "); 
    ...
    switch (P_EAX) {
		...
		case 3: Affiche_Chaine((UCHAR*) (L_Base_Segment_Data + P_EBX));
			break;
		case 4: Regle_Couleur(P_ECX & 0xFF);
			Affiche_Chaine((UCHAR*) (L_Base_Segment_Data + P_EBX));
			break;
		case 5:
			Affiche_Chaine_Caractere((UCHAR*) (L_Base_Segment_Data + P_EBX), P_ECX & 0xFF);
			break;
